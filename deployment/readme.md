1. Copy `Service-BlockchainNodeStatuses` and `Service-BlockchainNodeStatuses-Worker` to the https://github.com/swisschain/kubernetes-swisschain/tree/master/Kubernetes/03.Pods/Tools. 
